...
def menu():
    ...
    print('5 - добавление новой записи')
...
def search(data):
    what = input('Введите данные для поиска: ')  
    search_data = [elem for elem in data if what in elem] 
    printinfo(search_data) 
...
def add_record(data):
    ...
    tel = input('Введите номер телефона нового человека: ')
...
def main ():
    my_choice = -1
    changed = False
    operations = {1: printinfo, 2: export_to_csv, 3: search, 4: delete, 5: add_record}
